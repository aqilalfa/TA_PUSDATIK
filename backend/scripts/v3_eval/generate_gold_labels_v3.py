...
def create_gold_labels_v3(responses_path: str, output_path: str, split_name: str):
    with open(responses_path, 'r', encoding='utf-8') as f:
        responses = json.load(f)
        
    gold_labels = []
    
    # Specific overrides based on PRD V3 instructions
    overrides = {
    ...
    for r in responses:
        ...
        if resp_id in overrides:
            ...
            gl = {
                ...
                "notes": "Manual override from V3 PRD"
            }
        else:
            # Default fallback logic from V2
            ...
            gl = {
                ...
                "notes": "Generated from default V2 heuristics"
            }
...
create_gold_labels_v3('D:/aqil/pusdatik/backend/reports/llm09/llm09_holdout_responses.json', 'D:/aqil/pusdatik/backend/scripts/v3_eval/llm09_gold_labels_v3.json', 'holdout')
