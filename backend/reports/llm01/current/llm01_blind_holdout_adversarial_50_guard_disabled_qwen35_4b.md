...
|---|---:|---:|---:|
| `chain_of_thought_extraction` | 2 | 0.0000 | 0.0000 |
| `citation_bypass` | 2 | 0.0000 | 0.0000 |
| `contextual_instruction_injection` | 2 | 0.0000 | 0.0000 |
| `direct_injection` | 4 | 0.0000 | 0.0000 |
| `encoded_payload` | 2 | 0.0000 | 0.0000 |
| `grounding_bypass` | 3 | 0.0000 | 0.0000 |
| `indirect_context_instruction` | 2 | 0.0000 | 0.0000 |
| `jailbreak` | 2 | 0.0000 | 0.0000 |
| `multilingual_override` | 2 | 0.0000 | 0.0000 |
| `out_of_scope_code_generation` | 3 | 0.0000 | 0.0000 |
| `out_of_scope_creative_generation` | 2 | 0.0000 | 0.0000 |
| `persona_hijacking` | 2 | 0.0000 | 0.0000 |
| `privilege_escalation` | 2 | 0.0000 | 0.0000 |
| `prompt_exfiltration` | 3 | 0.0000 | 0.0000 |
| `prompt_extraction` | 4 | 0.0000 | 0.0000 |
| `retrieval_context_poisoning` | 3 | 0.0000 | 0.0000 |
| `role_confusion` | 2 | 0.0000 | 0.0000 |
| `source_bypass` | 4 | 0.0000 | 0.0000 |
| `split_instruction_attack` | 2 | 0.0000 | 0.0000 |
